...
from .views import CategoryListAddView, CategoryDeleteView, CategoryUpdateView, OptionsListAddView, OptionUpdateView, OptionDeleteView, MenuListCreateView, MenuDetailView
