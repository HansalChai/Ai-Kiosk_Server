...
from .views import CategoryListAddView, CategoryUpdateView, CategoryDeleteView, OptionsListAddView, OptionUpdateView, OptionDeleteView, MenuListCreateView, MenuDetailView, OrderAmountView, OrderCreateView
